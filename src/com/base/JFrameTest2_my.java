...
public class JFrameTest2_my implements ActionListener{
	//선언부
	...
	public void actionPerformed(ActionEvent e) {
		String command = e.getActionCommand();	//command에 이벤트를 통한 결과를 담음
		System.out.println(command+", "+e.getSource());
		if(e.getSource()==jbtn_exit) {	//너가 누른 것의 주소와 exit버튼의 주소가 같니?
			System.exit(0);	//자바가상머신과의 연결고리가 끊어짐
		}else if("5".equals(command)) {	//문자열을 비교하는 코드=============================================
	...
	public static void main(String[] args) {
		...
		JFrameTest2_my rgView = new JFrameTest2_my();
		rgView.initDisplay();
